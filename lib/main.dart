                          ...
                          child: Ink(
                            decoration: BoxDecoration(
                              ...
                              gradient: RadialGradient(
                                colors: [Color(0xff3575f8), Color(0xff15278c)],
                            ...
                            child: FloatingActionButton(
                              ...
                              onPressed: () {
                                var givenWeight = weightCont.text
                                    .toString()
                                    .trim();
                                var givenFoots = footHeightCont.text
                                    .toString()
                                    .trim();
                                var givenInches = inchHeightCont.text
                                    .toString()
                                    .trim();
                                var givenGender = selectedGenderValue
                                    .toString()
                                    .trim();

                                if (givenWeight.isNotEmpty &&
                                    givenFoots.isNotEmpty &&
                                    givenInches.isNotEmpty) {
                                  try {
                                    ...
                                    if (weight <= 2 ||
                                      ...
                                      var bmi =
                                          weight / (totalMeters * totalMeters);
                                      setState(() {
                                        if (bmi <= 18.5) {
                                          bgColor = Colors.red;
                                          chngColor = bgColor;
                                    ...
                                    setState(() {
                                      bmiResult =
                                          "Please Fill Number Only in all the Fields";
                                      bgColor = Colors.yellow;
                                      chngColor = Colors.black;
                                      cautionBGColor = Colors.yellow;
                                      imageIndex = 0;
                        ...
                        child: Material(
                          ...
                          child: Ink(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              gradient: RadialGradient(
                                colors: [Color(0xff3074f8), Color(0xff15278c)],
                                center: Alignment.center,
                                radius: 1.3,
                              ),
                            ),
                      ...
                      Container(
                        decoration: bmiResult.isNotEmpty
                            ? BoxDecoration(
                                ...
                                border: Border.all(width: 2, color: chngColor),
                              )
                            : null,
                        child: Padding(
